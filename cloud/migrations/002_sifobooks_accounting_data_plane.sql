-- SifoBooks PostgreSQL accounting data plane
-- Generated from the canonical SQLite schema. SQLite remains the offline default.
...
CREATE TABLE IF NOT EXISTS "asset_categories" (
  ...
  "capitalisation_threshold" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "asset_disposals" (
  ...
  "disposal_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
...
CREATE TABLE IF NOT EXISTS "bank_accounts" (
  ...
  "opening_date" TEXT DEFAULT CURRENT_DATE,
  "gl_account_id" TEXT,
  "is_active" INTEGER NOT NULL DEFAULT 1,
  "notes" TEXT,
  "updated_at" TEXT NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS "cost_centres" (
  ...
  "code" TEXT,
  "description" TEXT,
  "annual_budget" DOUBLE PRECISION DEFAULT 0,
  "updated_at" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "csat_responses" (
  ...
  "response_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
  "updated_at" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "employee_deductions" (
  ...
  "initial_deposit" DOUBLE PRECISION DEFAULT 0,
  ...
  "total_interest" DOUBLE PRECISION DEFAULT 0,
  "interest_monthly" DOUBLE PRECISION DEFAULT 0,
  "interest_outstanding" DOUBLE PRECISION DEFAULT 0,
  "data1" DOUBLE PRECISION DEFAULT 0,
  "data2" DOUBLE PRECISION DEFAULT 0,
  "data3" DOUBLE PRECISION DEFAULT 0,
  "currency" TEXT NOT NULL DEFAULT 'ZMW',
  "status" TEXT NOT NULL DEFAULT 'Active',
  "updated_at" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "employee_incomes" (
  ...
  "amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "currency" TEXT NOT NULL DEFAULT 'ZMW',
  "hours_days_worked" DOUBLE PRECISION DEFAULT 0,
  "data1" DOUBLE PRECISION DEFAULT 0,
  "data2" DOUBLE PRECISION DEFAULT 0,
  "data3" DOUBLE PRECISION DEFAULT 0,
  "effective_from" TEXT,
...
CREATE TABLE IF NOT EXISTS "fixed_assets" (
  ...
  "status" TEXT NOT NULL DEFAULT 'active',
  "disposal_date" TEXT,
  "disposal_proceeds" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "hospitality_tax_profiles" (
  ...
  "vat_rate" DOUBLE PRECISION NOT NULL DEFAULT 16,
  "tourism_levy_rate" DOUBLE PRECISION NOT NULL DEFAULT 1.5,
...
CREATE TABLE IF NOT EXISTS "hotel_events" (
  ...
  "package_rate" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "hotel_folio_charges" (
  ...
  "charge_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
  ...
  "amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "vat_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "levy_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "hotel_guests" (
  ...
  "notes" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "hotel_night_audits" (
  ...
  "room_revenue" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "fnb_revenue" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "other_revenue" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "vat_total" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "levy_total" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "service_charge_total" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "hotel_rate_plans" (
  ...
  "extra_adult_rate" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "extra_child_rate" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "customer_id" TEXT,
...
CREATE TABLE IF NOT EXISTS "leave_register" (
  ...
  "normal_accrual" DOUBLE PRECISION DEFAULT 2,
  "total_days" DOUBLE PRECISION DEFAULT 0,
  "leave_days_taken" DOUBLE PRECISION DEFAULT 0,
  "closing_balance" DOUBLE PRECISION DEFAULT 0,
  "leave_value" DOUBLE PRECISION DEFAULT 0,
  "notes" TEXT,
  "status" TEXT NOT NULL DEFAULT 'Active',
  "updated_at" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "loan_schedule" (
  ...
  "due_date" TEXT NOT NULL,
  "opening_balance" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "principal_due" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "interest_due" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "loans" (
  ...
  "total_interest" DOUBLE PRECISION DEFAULT 0,
  "total_repayable" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "management_reports" (
  ...
  "prepared_by" TEXT,
  "prepared_at" TEXT NOT NULL DEFAULT now(),
  "reviewed_by" TEXT,
  "approved_at" TEXT,
  "status" TEXT NOT NULL DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS "moe_programmes" (
  ...
  "default_percentage" DOUBLE PRECISION
);
...
CREATE TABLE IF NOT EXISTS "napsa_icare_entries" (
  ...
  "employer_contribution" DOUBLE PRECISION DEFAULT 0,
  "employee_contribution" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "pay_grades" (
  ...
  "mid_salary" DOUBLE PRECISION DEFAULT 0,
  "max_salary" DOUBLE PRECISION DEFAULT 0,
  "housing_allowance" DOUBLE PRECISION DEFAULT 0,
  "transport_allowance" DOUBLE PRECISION DEFAULT 0,
  "description" TEXT,
  "status" TEXT NOT NULL DEFAULT 'Active',
  "updated_at" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "payroll_deduction_types" (
  ...
  "employer_rate" DOUBLE PRECISION DEFAULT 0,
  "basis" TEXT DEFAULT 'Gross',
  "earn_inclusion" TEXT DEFAULT 'Taxable',
  "earn_exclusion" TEXT,
  "earnings_max" DOUBLE PRECISION DEFAULT 0,
  "annual_tax_limit" DOUBLE PRECISION DEFAULT 0,
  "tax_pct" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "payroll_income_types" (
  ...
  "taxable_pct" DOUBLE PRECISION DEFAULT 100,
...
CREATE TABLE IF NOT EXISTS "payroll_runs" (
  ...
  "total_paye" DOUBLE PRECISION DEFAULT 0,
  "total_napsa" DOUBLE PRECISION DEFAULT 0,
  "total_nhima" DOUBLE PRECISION DEFAULT 0,
  "total_net" DOUBLE PRECISION DEFAULT 0,
  "notes" TEXT,
  "updated_at" TEXT NOT NULL DEFAULT now(),
  "currency" TEXT NOT NULL DEFAULT 'ZMW',
  "total_wcf" DOUBLE PRECISION,
  "prepared_by" TEXT
);
...
CREATE TABLE IF NOT EXISTS "payroll_statutory_filings" (
  ...
  "period_month" INTEGER NOT NULL,
  "employees_count" INTEGER NOT NULL DEFAULT 0,
  "employee_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "employer_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "total_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "payroll_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "payroll_statutory_rules" (
  ...
  "napsa_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.05,
  "napsa_employer_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.05,
  "napsa_cap" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "nhima_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.01,
  "nhima_employer_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.01,
  "wcf_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.015,
  "sdl_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.005,
  "housing_exempt_pct" DOUBLE PRECISION NOT NULL DEFAULT 0.30,
  "source_note" TEXT,
  "verified_by" TEXT,
  "verified_on" TEXT,
  "is_active" INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS "payslips" (
  ...
  "napsa" DOUBLE PRECISION DEFAULT 0,
  "nhima" DOUBLE PRECISION DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "petty_cash" (
  ...
  "company_id" TEXT,
  "voucher_no" TEXT,
  "txn_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
...
CREATE TABLE IF NOT EXISTS "reconciliation_sessions" (
  ...
  "opening_balance" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "book_balance" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cleared_deposits" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cleared_payments" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "difference" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "status" TEXT NOT NULL DEFAULT 'draft',
  "notes" TEXT,
  "locked_at" TEXT,
...
CREATE TABLE IF NOT EXISTS "restaurant_cash_drawers" (
  ...
  "station" TEXT,
  "business_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
  "opened_at" TEXT NOT NULL DEFAULT now(),
  "closed_at" TEXT,
  "opening_float" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cash_sales" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cash_payouts" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cash_drops" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "expected_cash" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "counted_cash" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_end_of_day" (
  ...
  "delivery_fees" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "cash_sales" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "card_sales" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "momo_sales" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_loyalty_accounts" (
  ...
  "lifetime_spend" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_order_types" (
  ...
  "packaging_fee" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "default_gratuity_pct" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "price_key" TEXT,
  "sort_order" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_payments" (
  ...
  "method" TEXT NOT NULL DEFAULT 'cash',
  "amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "tendered" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_reservations" (
  ...
  "reserved_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
...
CREATE TABLE IF NOT EXISTS "restaurant_settings" (
  ...
  "user_id" TEXT NOT NULL,
  "business_name" TEXT,
  "vat_rate" DOUBLE PRECISION NOT NULL DEFAULT 0.16,
  "service_charge_pct" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "restaurant_shifts" (
  ...
  "clock_in" TEXT NOT NULL DEFAULT now(),
  "clock_out" TEXT,
  "declared_tips" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "business_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
  "created_by" TEXT
);
...
CREATE TABLE IF NOT EXISTS "school_admissions" (
  "id" TEXT PRIMARY KEY,
  "user_id" TEXT NOT NULL DEFAULT CURRENT_DATE
);
...
CREATE TABLE IF NOT EXISTS "school_attendance" (
  "id" TEXT PRIMARY KEY,
  "user_id" TEXT NOT NULL DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS "stock_adjustments" (
  ...
  "adjustment_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
  "item_id" TEXT,
  "warehouse_id" TEXT,
...
CREATE TABLE IF NOT EXISTS "students" (
  ...
  "date_of_birth" TEXT,
  "class_id" TEXT,
  "enrolment_date" TEXT DEFAULT CURRENT_DATE,
  "guardian_name" TEXT,
  "guardian_phone" TEXT,
  "guardian_email" TEXT,
...
CREATE TABLE IF NOT EXISTS "supplier_quotations" (
  ...
  "quoted_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "teaching_material_requests" (
  ...
  "request_date" TEXT NOT NULL DEFAULT CURRENT_DATE,
