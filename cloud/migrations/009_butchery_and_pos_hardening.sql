-- SifoBooks Cloud: butchery and POS hardening.
...
-- Cloud query executor qualifies user_id against the root table when joins are present.
-- This migration only creates the data structures; application SQL qualification is handled in code.
