...
function Tables() {
  ...
  const counts = useMemo(() => {
    const by = (s: string) => tables.filter((t) => { const v=String(t.status||"available").toLowerCase(); return (v==="free"?"available":v)===s; }).length;
