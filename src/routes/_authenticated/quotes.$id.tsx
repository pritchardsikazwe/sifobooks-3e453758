...
function QuoteDetailPage() {
  ...
  return (
    <SifoDocumentLayout
      ...
      /><div className="grid gap-3 sm:grid-cols-3"><Card><CardContent className="p-4"><div className="text-xs text-muted-foreground">Accounting</div><div className="mt-1 font-medium">No GL posting from quotation</div><div className="text-xs text-muted-foreground mt-1">Posting occurs when the downstream invoice is posted.</div></CardContent></Card><Card><CardContent className="p-4"><div className="text-xs text-muted-foreground">Inventory</div><div className="mt-1 font-medium">No stock movement</div><div className="text-xs text-muted-foreground mt-1">A quotation reserves no stock by itself.</div></CardContent></Card><Card><CardContent className="p-4"><div className="text-xs text-muted-foreground">Lifecycle</div><div className="mt-1"><Badge variant="secondary" className="capitalize">{quote.status}</Badge></div></CardContent></Card></div>}
