...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SifoBooks — Accounting ERP" },
      { name: "description", content: "SifoBooks is a complete accounting ERP for African businesses — invoicing, purchases, inventory, payroll, and tax compliance in one platform." },
      { property: "og:title", content: "SifoBooks — Accounting ERP" },
      { property: "og:description", content: "SifoBooks is a complete accounting ERP for African businesses — invoicing, purchases, inventory, payroll, and tax compliance in one platform." },
      ...
      { name: "theme-color", content: "#0e8f4a" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "SifoBooks" },
    ...
    links: [
      ...
      { rel: "icon", href: "/sifobooks-logo.svg", type: "image/svg+xml" },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "apple-touch-icon", href: "/sifobooks-logo.svg" },
    ],
  }),
