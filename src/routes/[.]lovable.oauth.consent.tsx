  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md items-center p-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle>Connect {name} to Sifobooks</CardTitle>
          <CardDescription>
            {name} will be able to read your Sifobooks data — customers, invoices, expenses, inventory, sales and
            account balances — as you.
          </CardDescription>
        </CardHeader>
