...
function BoardingForm({ kind, students, houses, rooms, beds, meals, onClose, onSave, saving }: any) {
  ...
  if(kind==="bed") body=<><Select label="House" name="house_id" options={houses.map((x:any)=>[x.id,x.name])}/><Field label="Bed code" name="bed_code" required/><Select label="Status" name="status" options={[["vacant","Vacant"],["maintenance","Maintenance"],["out_of_service","Out of service"]]}/></>;
