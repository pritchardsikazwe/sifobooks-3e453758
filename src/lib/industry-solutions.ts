...
export const INDUSTRY_SOLUTIONS: IndustrySolution[] = [
  ...
  },
  {
    ...
    features: [
      ...
      F("lending.savings", "Savings", false),
      F("lending.investors", "Investor Management", false),
      F("lending.customer_portal", "Borrower Portal", false),
      F("lending.risk_fraud", "Risk & Fraud Controls", false),
      F("lending.whatsapp", "SMS / WhatsApp Notifications", false),
