...
export async function buildPayslipPdf(i: PayslipPdfInput): Promise<jsPDF> {
  ...
  const footerRight = i.company?.payslip_footer || "This is a computer generated payslip — no signature required unless stamped.";
  pdf.text(footerRight, W - 32, H - 20, { align: "right", maxWidth: W - 260 });
