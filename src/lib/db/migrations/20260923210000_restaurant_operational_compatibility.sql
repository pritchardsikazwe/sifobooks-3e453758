-- Restaurant / purchasing compatibility for existing SQLite databases.
-- The runtime also has a defensive compatibility layer; this migration keeps
-- the schema explicit for fresh and upgraded portable databases.
