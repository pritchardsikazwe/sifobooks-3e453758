...
export const restaurantDemo: DemoIndustry = {
  ...
  sections: [
    ...
    {
      slug: "menu",
      name: "Menu, categories & modifiers",
      group: "Menu",
