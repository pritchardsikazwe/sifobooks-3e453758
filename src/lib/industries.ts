...
export const INDUSTRIES: Industry[] = [
  ...
  {
    id: "ngo", label: "NGO", emoji: "🤲", tagline: "Donors, grants, projects.",
    modules: [
      M("ngo_donors", "Donors", "Donor registry."),
      M("ngo_grants", "Grants", "Grant agreements."),
      M("ngo_projects", "Projects", "Project budgets."),
      M("ngo_monitoring", "M&E", "Monitoring and evaluation."),
    ],
    coa: [
      { account_code: "4100", account_name: "Grants Received", account_type: "revenue" },
